...
export const predictTrafficDelay = async (recentDelays, timeOfDay, dayOfWeek, weather, accidents, concerts, strikes, otherEvents, start, end) => {
  try {
...
export const detectAnomaly = async (delay, hour, dayOfWeek) => {
  try {
